...
class Proposal extends Model
{
   ...
   public function memberProposal()
   {
    ...
    {
        $arr=\App\Proposal::join('proposal_versions','proposals.id','=','proposal_versions.proposal_id')->whereNull('deleted_at')->where('proposal.id','=',$v)->get();
            return $arr;
    ...
    public static function AllGrantVersion($prop_id)
    {
        $arr=\App\Proposal::join('proposal_versions','proposals.id','=', 'proposal_versions.proposal_id')
        ->where('proposal_versions.proposal_id','=',$prop_id)->orderby('proposal_versions.version_number','DESC')->get();
          return $arr;
    }
}
